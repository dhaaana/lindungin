    ...
    <div class="row">
      <div class="col-9 border">
          <div class="row mx-3 mt-3 d-flex align-items-center">
              <div class="col-6">
                <button class="badge bg-light text-dark">New</button>
                <button class="badge bg-light text-dark">Top</button>
                <button class="badge bg-danger">Hot</button>
                <button class="badge bg-light text-dark">Closed</button>
              </div>
              <div class="col-6"></div>
          </div>
           <!--- \\\\\\\Post-->
